...
const Footer = ({ title }) => {
  ...
  return (
    ...
    >
      ...
      <i className='fas fa-copyright' /> {`${copyrightDate}`} <span><i className='mx-1 animate-pulse fas fa-heart'/> <a href={siteConfig('LINK')} className='underline font-bold  dark:text-gray-300 notranslate'>{siteConfig('AUTHOR')}</a>.<br/>
      <Poetry/>
