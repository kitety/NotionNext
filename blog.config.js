...
const BLOG = {
  AUTHOR: 'Kitety', // 作者
  BIO: '独特为佳', // 作者简介
  LINK: 'https://www.kitety.life/', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || 'e3d485ba8970463e92f1ad45c919dff8', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'aizaizuori@gmail.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/kitety',
  CONTACT_TELEGRAM: '',
  ...
  COMMENT_DAO_VOICE_ID: process.env.NEXT_PUBLIC_COMMENT_DAO_VOICE_ID || '1e4e8331', // DaoVoice http://dashboard.daovoice.io/get-started
  ...
  ANALYTICS_BAIDU_ID:
    ...
    '03355ec2c0f36e8ff61c3ff1f137c57a', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ANALYTICS_CNZZ_ID: process.env.NEXT_PUBLIC_ANALYTICS_CNZZ_ID || '', // 只需要填写站长统计的id, [cnzz_id] -> https://s9.cnzz.com/z_stat.php?id=[cnzz_id]&web_id=[cnzz_id]
  ANALYTICS_GOOGLE_ID:
    process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-VJJD98P863', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  ADSENSE_GOOGLE_ID: 'ca-pub-4938003046784968', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
